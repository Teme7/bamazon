...
connection.connect(function(err){
    if(err) throw err;
    console.log("Connection successful on Port number: " + connection.threadId);
    promptManager();
})
...
function addInventory(){
    ...
    connection.query(queryString, function(err, res){
        if (err) throw err;
        console.log("Review the items below to decide which item needs updating! Use the ID to do so.")
        console.log("----------------------------------------------------------------------------------" + '\n');
